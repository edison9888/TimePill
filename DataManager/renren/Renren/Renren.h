 ...
 */
#define kAPP_ID     @"222749"
#define kAPI_Key    @"38ee2eda5ea140899e00b696fcc2c09d"
...
/*获取评论*/
-(void)getUserComments:(ROCommentsRequestParam *)param andDelegate:(id<RenrenDelegate>)delegate;
